...
$messages['ast'] = array(
	...
	'translate-svg-new-summary' => "Pa principiar la traducción d'esti ficheru, seleicione la llingua '''dende''' la que va facer la traducción (si ye ambiguo, seleicione la llingua más falada).",
	'translate-svg-new-label' => 'Llingua:',
	'translate-svg-new-error-import' => "'''Hebo un error:''' Hebo un error desconocíu al intentar crear les páxines necesaries pa traducir esti SVG.",
	'translate-svg-new-error-group' => "'''Hubo un error:''' Hubo un error desconocíu; ¿escaecería, seique, especificar un grupu na URL?",
...
$messages['pms'] = array(
	...
	'translate-svg-new-summary' => "Për ancaminé la tradussion dë st'archivi, për piasì ch'a selession-a la lenga '''a parte da la qual''' chiel a vòlta st'archivi '''da''' (se a l'é nen sigur, ch'a selession-a la lenga pi dovrà).",
	'translate-svg-new-label' => 'Lenghe',
	'translate-svg-new-error-import' => "'''A l'é capitaje n'eror:''' N'eror pa conossù a l'é capità antramente ch'a provava a creé le pàgine necessarie për volté cost SVG.",
	'translate-svg-new-error-group' => "'''A l'é capitaje n'eror:''' A l'é capitaje n'eror pa conossù; miraco ha-lo dësmentià dë specifiché na partìa ant l'anliura?",
