...
$messages['ar'] = array(
	...
	'translate-svg-filepage-edit' => 'عدل',
...
$messages['ast'] = array(
	...
	'translate-taskui-export-as-svg' => 'Guardar nel ficheru SVG orixinal',
	'translate-svg-nodesc' => "(Nun se dio denguna descripción d'esti ficheru.)",
	'translate-svg-thumbnail' => 'Ficheru orixinal',
	'translate-svg-js-thumbnail' => '(la miniatura anuevase automáticamente)',
	'translate-page-description-legend-svgmg' => 'Información tocante a esti ficheru',
	'translate-taction-mstats-svgmg' => 'Estadístiques del ficheru',
	'translate-taction-export-svgmg' => 'Xubir la versión anovada del ficheru',
	'translate-svg-table-header' => 'Identificador del mensaxe',
	'translate-svg-filepage-caption' => "Esta imaxe renderizada como PNG n'otres llingües: $1",
	'translate-svg-filepage-caption-translator' => "Esta imaxe renderizada como PNG n'otres llingües: $1; o traducir a $2",
	'translate-svg-filepage-edit' => 'editar',
	'translate-svg-filepage-finish' => 'acabar',
	'translate-svg-filepage-another' => 'otru idioma',
	'translate-svg-filepage-other' => 'otros idiomes',
	'translate-svg-filepage-invite' => 'Esti ficheru pue traducise fácilmente a $1',
	'translate-svg-autocreate' => 'Creando automáticamente les unidaes de traducción basaes en cambios na fonte del ficheru SVG',
	'translate-svg-autodelete' => 'Desaniciando automáticamente les unidaes de traducción innecesaries basaes en cambios na fonte del ficheru SVG',
	'translate-svg-autoedit' => 'Anovando automáticamente les traducciones basaes en cambios na fonte del ficheru SVG',
	'translate-svg-autofuzzy' => 'Marcando automáticamente como anticuaes les traducciónes basaes en cambios na fonte del ficheru SVG',
	'translate-svg-upload-comment' => 'Anovando les traducciones (aniciao: $1; camudao/enantao: $2)',
	'translate-svg-upload-none' => '(nenguna)',
	'translate-svg-chooselanguage-title' => "Seleición d'idioma",
	'translate-svg-chooselanguage-desc' => "Seleicione l'idioma al que quier traducir esti ficheru SVG:",
	'translate-svg-instructions-title' => "¿Ye la primera vez que traduz un ficheru SVG d'esti mou?",
	'translate-svg-instructions-desc' => 'Para empezar, calque nun identificador de mensaxe de la primera columna de la tabla que s\'ufre pa principiar la traducción d\'esi mensaxe, usando los botones "$1" y "$2" pa navegar pelos mensaxes que necesiten traducción. Cuando termine, recuerde usar la llingüeta "$3" pa guardar les traducciones nel ficheru orixinal.',
	'translate-svg-warn' => '<strong>Atención:</strong>Inda hai traducciones nesti idioma ensin guardar, que nun se verán fasta que dalguién $1.',
	'translate-svg-warn-inner' => 'guarde esos cambios nel ficheru orixinal',
	'translate-svg-new-title' => 'Traducción de SVG',
	'translate-svg-new-summary' => "Pa principiar la traducción d'esti ficheru, seleicione la llingua <strong>dende</strong> la que va facer la traducción (si ye ambiguo, seleicione la llingua más falada).",
	'translate-svg-new-label' => 'Llingua:',
	'translate-svg-new-error-import' => '<strong>Hebo un error:</strong> Hebo un error desconocíu al intentar crear les páxines necesaries pa traducir esti SVG.',
	'translate-svg-new-error-group' => '<strong>Hubo un error:</strong> Hubo un error desconocíu; ¿escaecería, seique, especificar un grupu na URL?',
	'translate-svg-export-unsupported' => "La esportación de vuelta a un SVG nun tien sofitu pa esti grupu de mensaxes. Si nun ye obvio por qué asocedió, pue querer informar d'esti error en $1.",
	'translate-svg-export-error' => "Hubo un error inesperáu al intentar guardar los cambios ficheru. Seique quiera informar d'esti error en $1.",
	'translate-js-properties-legend' => 'Propiedaes',
	'translate-js-label-x' => 'Coordenada X:',
	'translate-js-label-y' => 'Coordenada Y:',
	'translate-js-label-color' => 'Color:',
	'translate-js-label-font-family' => 'Tipografía:',
	'translate-js-label-bold' => 'Negrina',
	'translate-js-label-italic' => 'Cursiva',
	'translate-js-label-underline' => 'Sorrayao',
...
$messages['be-tarask'] = array(
	...
	'translate-svg-new-summary' => 'Каб пачаць пераклад гэтага файла, выберыце мову, <strong>зь якой</strong> вы будзеце перакладаць (калі ня ведаеце, выбіраце найбольш распаўсюджаную мову).',
...
$messages['de'] = array(
	...
	'translate-svg-new-summary' => 'Um mit der Übersetzung anfangen zu können, wähle zunächst die Sprache aus <strong>aus</strong> der du diese Datei übersetzt. Wähle die am meisten gesprochene Sprache, sofern keine Sprache eindeutig auswählbar ist.',
	'translate-svg-new-label' => 'Sprache:',
	'translate-svg-new-error-import' => '<strong>Es ist ein Fehler aufgetreten:</strong> Beim Erstellen der Seiten, die notwendig sind, um diese SVG-Datei übersetzen zu können, ist ein unbekannter Fehler aufgetreten.',
	'translate-svg-new-error-group' => '<strong>Es ist ein Fehler aufgetreten:</strong> Es ist ein unbekannter Fehler aufgetreten. Vielleicht hast du vergessen, in der URL eine Gruppe anzugeben?',
...
$messages['de-formal'] = array(
	...
	'translate-svg-new-summary' => 'Um mit der Übersetzung anfangen zu können, wählen Sie zunächst die Sprache aus <strong>aus</strong> der Sie diese Datei übersetzen. Wählen Sie die am meisten gesprochene Sprache, sofern keine Sprache eindeutig auswählbar ist.',
	'translate-svg-new-error-group' => '<strong>Es ist ein Fehler aufgetreten:</strong> Es ist ein unbekannter Fehler aufgetreten. Vielleicht haben Sie vergessen, in der URL eine Gruppe anzugeben?',
...
$messages['eo'] = array(
	...
	'translate-svg-new-summary' => 'Por ektraduki tiun ĉi dosieron, bonvolu elekti la lingvon <strong>el</strong> kiu vi tradukas (do ne vian cellingvon).',
	'translate-svg-new-label' => 'Lingvo:',
	'translate-svg-new-error-import' => '<strong>Okazis eraro:</strong> Nekonata eraro okazis dum kreado de paĝoj necesaj por tradukado de tiu ĉi SVG.',
	'translate-svg-new-error-group' => '<strong>Okazis eraro:</strong> Nekonata eraro okazis; eble vi forgesis specifi grupon en la URL?',
...
$messages['es'] = array(
	...
	'translate-svg-new-summary' => 'Para comenzar la traducción de este archivo, selecciona el idioma <strong>desde</strong> el que vas a realizar la traducción de este archivo (si existe ambigüedad, selecciona el idioma más hablado).',
	'translate-svg-new-label' => 'Idioma:',
	'translate-svg-new-error-import' => '<strong>Ha ocurrido un error:</strong> Se produjo un error desconocido mientras se intentaba crear las páginas necesarias para traducir este archivo SVG.',
	'translate-svg-new-error-group' => '<strong>Ha ocurrido un error:</strong> Se ha producido un error desconocido. Tal vez olvidaste especificar un grupo en la dirección URL.',
...
$messages['fa'] = array(
	...
	'translate-taskui-export-as-svg' => 'ذخیره به پوشه اصلی اس‌وی‌جی',
	'translate-svg-nodesc' => '(هیچ شرحی برای پرونده ارائه نشده‌است.)',
	'translate-svg-thumbnail' => 'پروندهٔ اصلی',
	'translate-svg-js-thumbnail' => '(تصویر کوچک به طور خودکار به روز رسانی می‌شود)',
	'translate-page-description-legend-svgmg' => 'اطلاعات دربارهٔ این پرونده',
	'translate-taction-mstats-svgmg' => 'آمارهای پوشه',
	'translate-taction-export-svgmg' => 'انتقال نسخه پوشه به روز رسانی شده',
	'translate-svg-table-header' => 'پیغام شناسانه',
	'translate-svg-filepage-caption' => 'این تصویر به عنوان پی‌ان‌جی در زبان‌های دیگر ازائه شده: $1',
	'translate-svg-filepage-caption-translator' => 'این تصویر به عنوان پی‌ان‌جی در زبان‌های دیگر ارائه شده: $1؛ یا این را به $2 ترجمه کنید',
	...
	'translate-svg-autocreate' => 'ایجاد خودکار واحدهای ترجمه بر اساس تغییرات به پوشه منبع اس‌وی‌جی',
	'translate-svg-autodelete' => 'حذف خودکار واحدهای ترجمه غیرضروری بر اساس تغییرات به پوشه منبع اس‌وی‌جی',
	'translate-svg-autoedit' => 'به روز رسانی خودکار ترجمه‌ها براساس تغییرات به پوشه منبع اس‌وی‌جی',
	'translate-svg-autofuzzy' => 'علامت‌گذاری خودکار ترجمه‌ها به عنوان نامشخص براساس تغییرات در پوشه منبع اس‌وی‌جی',
	'translate-svg-upload-comment' => 'به روز رسانی ترجمه‌ها (شروع شده: $1 ؛ تغییر یافته/گسترش داده: $2)',
	'translate-svg-upload-none' => '(هیچ)',
	'translate-svg-chooselanguage-title' => 'انتخاب زبان',
	'translate-svg-chooselanguage-desc' => 'لطفاً زبانی را انتخاب کنید که می‌خواهید این پوشه اس‌وی‌جی را به آن ترجمه کنید:',
	'translate-svg-instructions-title' => 'اولین بار ترجمه پوشه اس‌وی‌جی به این روش؟',
	'translate-svg-instructions-desc' => 'برای شروع، روی شناسه پیامی کلیک کنید که در ستون اول جدول ارائه شده برای شروع ترجمه آن پیام، با استفاده از دکمه‌های «$1» و «$2» برای کمک به حرکت از طریق پیام‌های که نیاز به ترجمه دارند. زمانی که انجام دادید، برای استفاده از برگه «$3» برای ذخیره ترجمه‌های خود به پروندهٔ اصلی، به یاد داشته باشید.',
	'translate-svg-warn' => '<strong>هشدارː</strong>در حال حاضر ترجمه‌های ذخیره نشده در این زبان وجود دارند برای شما یا کس دیگری قابل مشاهده نخواهدبود $1.',
	'translate-svg-warn-inner' => 'ذخیره آن تغییرات به پوشه اصلی',
	'translate-svg-new-title' => 'ترجمهٔ اس‌وی‌جی',
	'translate-svg-new-summary' => "برای شروع ترجمه این پوشه، لطفاً زبانی را انتخاب کنید که شما این پوشه '''از''' را ترجمه می‌کنید (اگر مبهم است، گسترده‌ترین زبان گفته شده را انتخاب کنید).",
	'translate-svg-new-label' => 'زبان:',
	'translate-svg-new-error-import' => "'''خطایی رخ داده‌استː''' خطایی ناشناخته هنگام تلاش برای ایجاد صفحات مورد نیاز برای ترجمه این اس‌وی‌جی رخ داده‌است.",
	'translate-svg-new-error-group' => "'''خطایی رخ داده‌استː''' خطایی ناشناخته رخ داده‌است؛ شاید شما برای تعیین یک گروه در یوآر‌ال فراموش کرده‌اید؟",
	'translate-svg-export-unsupported' => 'صادرات به اس‌وی‌جی برای این گروه پیام پشتیبانی نشده‌است. اگر واضح نیست که چرا این رخ داده‌است، ممکن است شما مایل به یک پوشه غلط درباره این در$1  باشید.',
	'translate-svg-export-error' => 'هنگام تلاش برای ذخیره تغییرات خود به پوشه، خطای غیرمنتظره‌ای رخ داد. ممکن است شما مایل به یک پوشه غلط درباره این در$1  باشید.',
...
$messages['fr'] = array(
	...
	'translate-svg-new-summary' => "Pour commencer la traduction de ce fichier, veuillez sélectionner la langue <strong>à partir de laquelle</strong> vous traduisez ce fichier (si vous n'êtes pas certain(e) de la langue à indiquer, sélectionnez la langue plus utilisée).",
	'translate-svg-new-label' => 'Langue :',
	'translate-svg-new-error-import' => "<strong> Une erreur s'est produite </strong>: Une erreur inconnue s'est produite lors de la tentative de création des pages nécessaires pour traduire ce SVG.",
	'translate-svg-new-error-group' => "<strong> Une erreur s'est produite </strong>: Une erreur inconnue s'est produite ; vous avez peut-être oublié de spécifier un groupe dans l'URL ?",
...
$messages['gl'] = array(
	...
	'translate-svg-new-summary' => 'Para comezar a tradución deste ficheiro, seleccione a lingua <strong>desde</strong> a que vai realizar a tradución (se non sabe, seleccione a lingua máis falada).',
	'translate-svg-new-label' => 'Lingua:',
	'translate-svg-new-error-import' => '<strong>Houbo un erro:</strong> Produciuse un erro descoñecido ao intentar crear as páxinas necesarias para a tradución deste ficheiro SVG.',
	'translate-svg-new-error-group' => '<strong>Houbo un erro:</strong> Produciuse un erro descoñecido. Se cadra esqueceu especificar un grupo no enderezo URL.',
...
$messages['he'] = array(
	...
	'translate-svg-new-summary' => 'כדי להתחיל לתרגם את הקובץ הזה, נא לבחור בשפה ש<strong>ממנה</strong> נעשה התרגום (אם לא ברור באיזו שפה לבחור, מומלץ לבחור בנפוצה ביותר).',
	'translate-svg-new-label' => 'שפה:',
	'translate-svg-new-error-import' => '<strong>אירעה שגיעה:</strong> שגיאה לא ידועה אירעה בעת ניסיון ליצור את הדפים הדרושים לתרגום ה־SVG הזה.',
	'translate-svg-new-error-group' => '<strong>אירעה שגיאה:</strong> אירעה שגיאה לא ידוע; אולי שכחת לציין קבוצה בכתובת?',
...
$messages['hsb'] = array(
	...
	'translate-svg-new-summary' => 'Zo by přełožowanje tuteje dataje započał, wubjer prošu rěč, <strong>z</strong> kotrejež přełožuješ (jeli to je njejasne, wubjer najwjace rěčanu rěč).',
	'translate-svg-new-label' => 'Rěč:',
	'translate-svg-new-error-import' => '<strong>Zmylk je wustupił:</strong> Njeznaty zmylk je wustupił, hdyž sy spytał, strony wutworić, kotrež su trěbne za přełožowanje tutoho SVG.',
	'translate-svg-new-error-group' => '<strong>Zmylk je wustupił:</strong> Njeznaty zmylk je wustupił: snano sy zabył, skupinu w URL podać?',
...
$messages['it'] = array(
	...
	'translate-svg-new-label' => 'Lingua:',
	'translate-svg-new-error-import' => '<strong>Si è verificato un errore:</strong> Errore sconosciuto provando a creare le pagine richieste per tradurre questo SVG.',
	'translate-svg-new-error-group' => "<strong>Si è verificato un errore:</strong> Errore sconosciuto, forse non è stato indicato un gruppo nell'URL?",
...
$messages['ko'] = array(
	...
	'translate-svg-new-summary' => '이 파일의 번역을 시작하려면 이 파일을 번역하는 <strong>출발</strong> 언어를 선택하세요. (모호한 경우 가장 널리 말하는 언어를 선택하세요)',
	'translate-svg-new-label' => '언어:',
	'translate-svg-new-error-import' => '<strong>오류가 발생했습니다:</strong> 이 SVG 번역에 필요한 문서를 만드는 동안 알 수없는 오류가 발생했습니다.',
	'translate-svg-new-error-group' => '<strong>오류가 발생했습니다:</strong> 알 수 없는 오류가 발생했습니다. 아마도 URL에서 그룹을 지정하는 잊었습니까?',
...
$messages['ksh'] = array(
	...
	'translate-svg-new-summary' => 'Öm mem Övversäze aanzefange, donn et eez di Schprooch beschtemme, <strong>vun</strong> woh di Dattei övversäz wääde sull. Em Zweivel, nämm di miehzjebruchte Schprooch.',
	'translate-svg-new-label' => 'De Schprooch:',
	'translate-svg-new-error-import' => '<strong>Ene Fähler es opjetrodde,</strong> beim Versohch, di Sigge aanzelääje, di för et Övversäzze vun dä <i lang="en">SVG</i>-Dattei nüüdesch sin.',
	'translate-svg-new-error-group' => '<strong>Ene Fähler es opjetrodde,</strong> wat jenou es nit kloh, velleisch had_Er verjäße, en Jropp em <i lang="en">URL</i> aanzejävve?',
...
$messages['mk'] = array(
	...
	'translate-svg-new-summary' => 'За да почнете со преведување на податотекава, најпрвин одберете <strong>од</strong> кој јазик ќе преведувате  (ако не е доволно јасно, одберете го најзастапениот јазик).',
	'translate-svg-new-label' => 'Јазик',
	'translate-svg-new-error-import' => '<strong>Се појави грешка</strong>: Се појави непозната грешка при обидот да ги создадам страниците потребни за преведување на оваа SVG-податотека.',
	'translate-svg-new-error-group' => '<strong>Се појави грешка</strong>: Се појави непозната грешка; да не заборавивте да укажете група во URL-адресата?',
...
$messages['ms'] = array(
	...
	'translate-svg-new-summary' => 'Untuk mula menterjemah fail ini, sila pilih bahasa <strong>asal</strong> fail ini (jika berbilang bahasa, pilih bahasa yang paling ketara).',
	'translate-svg-new-label' => 'Bahasa:',
	'translate-svg-new-error-import' => '<strong>Ralat:</strong> Berlakunya ralat yang tidak dikenali sewaktu cuba membuat halaman-halaman yang perlu untuk menterjemahkan SVG ini.',
	'translate-svg-new-error-group' => '<strong>Ralat:</strong> Berlakunya ralat yang tidak dikenali; jangan-jangan anda terlupa untuk menyatakan kumpulannya di dalam URL?',
...
$messages['nl'] = array(
	...
	'translate-svg-new-summary' => 'Selecteer de taal <strong>waaruit</strong> u dit bestand wilt vertalen om te beginnen met het vertalen van dit bestand. Als dit dubbelzinnig is, selecteer dan de meest gesproken taal.',
	'translate-svg-new-label' => 'Taal:',
	'translate-svg-new-error-import' => "<strong>Er is een fout opgetreden:</strong> er is een onbekende fout opgetreden tijdens het aanmaken van de pagina's die nodig zijn voor het vertalen van dit SVG-bestand.",
	'translate-svg-new-error-group' => '<strong>Er is een fout opgetreden:</strong> er is een onbekende fout opgetreden. Wellicht bent u vergeten een groep aan te geven in de URL?',
...
$messages['pl'] = array(
	...
	'translate-svg-filepage-invite' => 'Ten plik może łatwo przetłumaczyć na $1',
	'translate-svg-chooselanguage-title' => 'Wybór języka',
	'translate-svg-instructions-title' => 'Po raz pierwszy tłumaczysz ten sposób plik SVG?',
...
$messages['pms'] = array(
	...
	'translate-svg-autodelete' => "Scancelé automaticament j'unità ëd tradussion nen necessarie basà ansima a dij cangiament a l'archivi sorgiss SVG",
	'translate-svg-autoedit' => "Agiorné automaticament dle tradussion basà an sle modìfiche a l'archivi sorgiss SVG",
	'translate-svg-autofuzzy' => "Marché automaticament dle tradussion com tërbole an ocasion dle modìfiche a l'archivi sorgiss SVG",
	'translate-svg-upload-comment' => 'Agiornament ëd le tradussion (ancaminà: $1; modificà o spantià: $2)',
	'translate-svg-upload-none' => '(gnun)',
	'translate-svg-chooselanguage-title' => 'Selession ëd la lenga',
	'translate-svg-chooselanguage-desc' => "Për piasì, ch'a selession-a la lenga anté ch'a veul volté st'archivi SVG:",
	'translate-svg-instructions-title' => "Prima vira ch'a vòlta n'archivi SVG an sta manera?",
	'translate-svg-instructions-desc' => "Për ancaminé, ch'a sgnaca dzora n'identificator ëd mëssagi ant la prima colòna dla tàula fornìa për ancaminé la tradussion dël mëssagi, dovrand ij boton «$1» e «$2» ch'a lo giutran a navighé a travers ai mëssagi ch'a l'han damanca ëd na tradussion. Quand a l'ha fàit, ch'as visa ëd dovré la scheda «$3» për salvé soe tradussion ant l'archivi original.",
	'translate-svg-warn' => "<strong>Avis:</strong> A-i son al moment dle tradussion pa salvà an costa lenga, che a saran pa visìbij fin che chiel o quaidun d'àutr $1.",
	'translate-svg-warn-inner' => "a salva coste modìfiche ant l'archivi original",
	'translate-svg-new-title' => 'Tradussion SVG',
	'translate-svg-new-summary' => "Për ancaminé la tradussion dë st'archivi, për piasì ch'a selession-a la lenga '''a parte da la qual''' chiel a vòlta st'archivi (se a l'é nen sigur, ch'a selession-a la lenga pi dovrà).",
	'translate-svg-new-label' => 'Lenghe',
	'translate-svg-new-error-import' => "<strong>A l'é capitaje n'eror:</strong> N'eror pa conossù a l'é capità antramente ch'a provava a creé le pàgine necessarie për volté cost SVG.",
	'translate-svg-new-error-group' => "<strong>A l'é capitaje n'eror:</strong> A l'é capitaje n'eror pa conossù; miraco ha-lo dësmentià dë specifiché na partìa ant l'anliura?",
	'translate-svg-export-unsupported' => "Esporté andré a un SVG a l'é nen mantnù për costa partìa ëd mëssagi. S'a l'é nen ciàir përché sòn a l'é capità, a peul signalé n'eror a propòsit ëd sòn a $1.",
 ...
 */
$messages['ro'] = array(
	'translatesvg-desc' => 'Furnizează o interfață cu stil nativ pentru traducerea fișierelor SVG în acord cu specificațiile SVG1.1',
	'translate-svg-nodesc' => '(Nu a fost furnizată nicio descriere a fișierului.)',
	'translate-svg-thumbnail' => 'Fișier original',
	'translate-svg-js-thumbnail' => '(miniatura se actualizează automat)',
	...
	'translate-svg-filepage-caption' => 'Această imagine randată ca PNG în alte limbi: $1',
	'translate-svg-filepage-caption-translator' => 'Această imagine randată ca PNG în alte limbi: $1; sau traduceți-o în $2',
	'translate-svg-filepage-edit' => 'modificare',
	'translate-svg-filepage-finish' => 'finalizare',
	...
	'translate-svg-instructions-title' => 'Prima dată când traduceți un fișier SVG în acest mod?',
	'translate-svg-new-title' => 'Traducere SVG',
	...
	'translate-js-font-family-inherit' => '(moștenit)',
);
...
$messages['ru'] = array(
	...
	'translate-svg-new-summary' => 'Чтобы начать перевод этого файла, выберите язык, <strong>с которого</strong> вы переводите его (в случае сомнений выберите наиболее распространённый язык).',
	'translate-svg-new-label' => 'Язык:',
	'translate-svg-new-error-import' => '<strong>Ошибка:</strong> Произошла неизвестная ошибка при попытке создать страницы, необходимые для перевода этого SVG-файла.',
	'translate-svg-new-error-group' => '<strong>Ошибка:</strong> Произошла неизвестная ошибка; может, вы забыли добавить группу в URL?',
...
$messages['tl'] = array(
	...
	'translate-svg-new-summary' => 'Upang umpisahan ang pagsasalinwika ng talaksang ito, paki piliin ang wika na <strong>pinagmulan</strong> ng pagsasalinwika mo ng talaksang ito (kapag malabo, piliin ang pinaka malawak na sinasalitang wika).',
	'translate-svg-new-label' => 'Wika:',
	'translate-svg-new-error-import' => '<strong>Naganap ang isang kamalian</strong>: Naganap ang isang hindi nakikilalang kamalian habang sinusubukang likhain ang mga pahinang kailangan para sa pagsasalinwika ng SVG na ito.',
	'translate-svg-new-error-group' => '<strong>Naganap ang isang kamalian</strong>: Naganap ang isang hindi nakikilalang kamalian; marahil nakalimutan mong tukuyin ang isang pangkat na nasa loob ng URL?',
...
$messages['uk'] = array(
	...
	'translate-svg-new-summary' => 'Щоб розпочати переклад цього файлу, будь ласка, оберіть мову <strong>з якої</strong> Ви його перекладаєте (у разі сумнівів оберіть найбільш поширену мову)',
	'translate-svg-new-label' => 'Мова:',
	'translate-svg-new-error-import' => '<strong>Сталася помилка:</strong> Сталась невідома помилка при спробі створити сторінки, що необхідні для перекладу цього SVG-файлу.',
	'translate-svg-new-error-group' => '<strong>Сталася помилка:</strong> Сталась невідома помилка; можливо Ви забули додати групу до URL?',
...
$messages['vi'] = array(
	...
	'translate-svg-autocreate' => 'Tự động tạo các đơn vị dịch thuật theo các thay đổi vào tập tin SVG gốc',
	'translate-svg-autodelete' => 'Tự động xóa những đơn vị dịch thuật không cần thiết theo các thay đổi vào tập tin SVG gốc',
	'translate-svg-autoedit' => 'Tự động cập nhật các bản dịch theo các thay đổi vào tập tin SVG gốc',
	'translate-svg-autofuzzy' => 'Tự động đánh dấu các bản dịch là lỗi thời theo các thay đổi vào tập tin SVG gốc',
	'translate-svg-upload-comment' => 'Cập nhật các bản dịch (bắt đầu: $1; thay đổi/mở rộng: $2)',
	'translate-svg-upload-none' => '(không có)',
	'translate-svg-chooselanguage-title' => 'Lựa chọn ngôn ngữ',
	'translate-svg-chooselanguage-desc' => 'Xin vui lòng chọn ngôn ngữ để dịch tập tin SVG này ra:',
	'translate-svg-instructions-title' => 'Có phải là lần đầu tiên bạn dịch một tập tin SVG theo cách này?',
	...
	'translate-svg-new-error-import' => "'''Lỗi đã xảy ra:''' Đã xuất hiện một lỗi không rõ khi tạo các trang cần để dịch hình SVG này.",
	'translate-svg-new-error-group' => "'''Lỗi đã xảy ra:''' Đã xuất hiện một lỗi không rõ; có lẽ bạn đã quên định rõ một nhóm trong URL?",
...
$messages['zh-hans'] = array(
	...
	'translate-taction-export-svgmg' => '上传已上传文件的版本',
	'translate-svg-table-header' => '消息标识符',
	'translate-svg-filepage-caption' => '此图像在某些语言中呈现为PNG，包括语言：$1',
...
$messages['zh-hant'] = array(
	...
	'translate-svg-new-summary' => '要開始此檔案的翻譯，請選擇你要<strong>從</strong>哪種語言開始翻譯（若有歧義，選擇最廣泛使用的語言）。',
	'translate-svg-new-label' => '語言：',
	'translate-svg-new-error-import' => '<strong>出錯：</strong>嘗試創建翻譯此SVG檔案所需的頁面時出現未知錯誤。',
	'translate-svg-new-error-group' => '<strong>出錯：</strong>出現未知錯誤；也許你忘了於網址中指定組？',
