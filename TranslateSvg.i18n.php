...
$messages['dsb'] = array(
	...
	'translate-svg-new-summary' => 'Aby pśełožowanje zachopił, wubjeŕ pšosym rěc, <strong>z</strong> kótarejež pśełožujoš (jolic to jo njejasne, wubjeŕ nejwěcej powědanu rěc).',
	'translate-svg-new-label' => 'Rěc:',
	'translate-svg-new-error-import' => '<strong>Zmólka jo nastała:</strong> Njeznata zmólka jo nastała, gaž sy wopytał, boki napóraś, kótarež su trěbne za pśełožowanje toś togo SVG.',
	'translate-svg-new-error-group' => '<strong>Zmólka jo nastała:</strong> Njeznata zmólka jo nastała: snaź sy zabył, kupku w URL pódaś?',
...
$messages['hsb'] = array(
	...
	'translate-svg-new-summary' => 'Zo by přełožowanje započał, wubjer prošu rěč, <strong>z</strong> kotrejež přełožuješ (jeli to je njejasne, wubjer najwjace rěčanu rěč).',
