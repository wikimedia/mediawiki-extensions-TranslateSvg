...
$messages['de'] = array(
	...
	'translate-svg-export-unsupported' => 'Das Exportieren zu einer SVG-Datei wird für diese Nachrichtengruppe nicht unterstützt. Falls nicht eindeutig bekannt ist, warum dies passierte, kannst du einen Fehler auf bugzilla.wikimedia.org berichten.',
	'translate-svg-export-error' => 'Beim Speichern deiner Änderungen an der Datei ist ein unerwarteter Fehler aufgetreten. Vielleicht möchtest du diesen Fehler auf bugzilla.wikimedia.org berichten.',
...
$messages['de-formal'] = array(
	...
	'translate-svg-export-unsupported' => 'Das Exportieren zu einer SVG-Datei wird für diese Nachrichtengruppe nicht unterstützt. Falls nicht eindeutig bekannt ist, warum dies passierte, können Sie einen Fehler auf bugzilla.wikimedia.org berichten.',
	'translate-svg-export-error' => 'Beim Speichern Ihrer Änderungen an der Datei ist ein unerwarteter Fehler aufgetreten. Vielleicht möchten Sie diesen Fehler auf bugzilla.wikimedia.org berichten.',
);
...
$messages['gl'] = array(
	...
	'translate-svg-export-unsupported' => 'A exportación de volta a un SVG non está soportada por este grupo de mensaxes. Se non resulta obvio o motivo polo que aconteceu isto, quizais queira encher un formulario de erro no enderezo bugzilla.wikimedia.org.',
	'translate-svg-export-error' => 'Houbo un erro ao intentar gardar os cambios no ficheiro. Quizais queira encher un formulario de erro no enderezo bugzilla.wikimedia.org.',
...
$messages['he'] = array(
	...
	'translate-svg-export-unsupported' => 'ייצוא חזרה ל־SVG לא נתמך בקבוצות ההודעות הזאת. אם לא ברור לך למה זה קרה, כדאי לפתוח באג באתר https://bugzilla.wikimedia.org .',
	'translate-svg-export-error' => 'אירעה שגיאה לא צפויה בעת ניסיון לשמור את השינויים שלך חזרה אל הקובץ. כדאי לפתוח באג באתר https://bugzilla.wikimedia.org .',
...
$messages['mk'] = array(
	...
	'translate-svg-export-unsupported' => 'Извезувањето повторно во SVG не е подджано за оваа група пораки. Доколку причината не е очигледна, ви предлагаме да ја пријавите на bugzilla.wikimedia.org.',
	'translate-svg-export-error' => 'Се појави неочекувана грешка при обидот за зачувување на промените на податотеката. Ви предлагаме да ја пријавите на bugzilla.wikimedia.org.',
...
$messages['tl'] = array(
	...
	'translate-svg-export-unsupported' => 'Hindi sinusuportahan para sa pangkat na ito ng mensahe ang pagluluwas na pabalik papunta sa isang SVG. Kung hindi halata kung bakit ito naganap, maaaring naisin mong magharap ng isang surot patungkol dito roon sa bugzilla.wikimedia.org.',
	'translate-svg-export-error' => 'Isang hindi inaasahang kamalian ang nagapanap noong sinusubukang sagipin ang mga pagbabago mo na pabalik sa talaksan. Maaaring naisin mong magharap ng isang surot patungkol dito roon sa bugzilla.wikimedia.org.',
